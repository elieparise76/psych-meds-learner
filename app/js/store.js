...
(function () {
  ...
  function defaults() {
    return {
      ...
      settings: { theme: 'light', sound: true, voice: true, dailyGoal: 1, weeklyXpGoal: 210, motion: 'auto', tutorialSeen: false },
      ...
      progress: {
        ...
        bosses: {},          // (legacy) old per-branch boss completion
        reviews: {},         // "<branchId>:<tierIndex>" -> ISO date the row review was passed
      },
